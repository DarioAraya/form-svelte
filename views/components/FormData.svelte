...
export let response;
    ...
    <div class="grid-form form-input rut">
      ...
      <div class="mdc-text-field-helper-line">
        <div class="mdc-text-field-helper-text rut" aria-hidden="true">
    ...
    <div class="grid-form form-input actividad">
      <label class="mdc-text-field mdc-text-field--filled mdc-text-field--no-label" id="actividad">
        ...
        <input class="mdc-text-field__input actividad" type="text" placeholder="Escriba texto" aria-label="Label" value=""
          required />
    ...
    <div class="grid-form form-input form-button">
      <button type="button" class="mdc-button mdc-button--raised" id="dataCompanyButton">
